...
.SH NOTES
.R The \fB_printf()\fR is a project collaboration between \fBOsunsanmi Semilore\fR and \fBEmmanuella Amukwo\fR, actual students of Software Engineering at \fB Alx\fR.
.SH BUGS
.R In process
.SH EXAMPLE
...
.R printf(3)
.SH AUTHORS
Written by \Suara Ayomide\fR and \fB Remi Oni \fR.
